 ...
 * 
 * import guru.springframework.domain.Difficulty; import
 * guru.springframework.domain.Notes; import guru.springframework.domain.Recipe;
 * import guru.springframework.repositories.CategoryRepository; import
 * guru.springframework.repositories.RecipeRepository;
 * 
 * @Component public class DataLoader implements CommandLineRunner {
 * 
 * private RecipeRepository recRpo;
 * 
 * public DataLoader(RecipeRepository recRpo) { this.recRpo = recRpo; }
 * 
 * 
 ...
 * recipe1.setPrepTime(20); recipe1.setCookTime(15); recipe1.setServings(6);
 * recipe1.setSource("internet"); recipe1.setUrl(
 * "https://www.simplyrecipes.com/recipes/spicy_grilled_chicken_tacos/");
 * recipe1.setDirections("stir");
 * 
 * //recipe1.setImage(Byte.valueOf("")); recipe1.setDifficulty(Difficulty.EASY);
 * // recipe1.setNotes(); // recipe1.setIngredients());
 * 
 * recRpo.save(recipe1);
 * 
 * 
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public void onApplicationEvent(ContextRefreshedEvent event) {
        recipeRepository.saveAll(getRecipes()); //will save all recipes, list of recipes.
    }
    ...
    private List<Recipe> getRecipes() {
        ...
        //get optionals  // will need this for creating ingredients object
        ...
        guacRecipe.setNotes(guacNotes); //here in guacNotes.setRecipe also be set this recipe in recipe notes entity's seNotes method 

        //addIngredients method called where recipe already was set than this new ingredient will also set in that addIngredient method
